...
1. **Bíblia primeiro:** cada feature fecha com `docs/FutsalManager_Spec_v6.md` (secção relevante + changelog §19) atualizada **no mesmo passo** do código.
...
*Documento gerado a 2026-08-13. Fonte de verdade permanece `docs/FutsalManager_Spec_v6.md`. Este roadmap é um plano de execução — não altera a bíblia; cada task, ao ser executada, atualiza a bíblia no mesmo passo.*
