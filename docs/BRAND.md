...
Identidade visual do produto **Mister**. Complementa a secção 12 da bíblia (`Mister_Spec_v7.md`). Regra de ouro: **a marca do produto é fixa; a cor do clube é dinâmica**.
