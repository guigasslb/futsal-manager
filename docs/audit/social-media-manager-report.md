...
> Análise de potencial orgânico do **FutsalCoach** para Instagram e Facebook, focada no ecossistema de futsal de formação em Portugal (AF distritais, grupos de WhatsApp de treinadores, torneios de miúdos).
> Data: 2026-08-11
...
- **Nota UGC crítica:** o relatório traz sempre o rodapé "Relatório gerado por FutsalCoach" + logo no topo. **Cada partilha de pai = exposição de marca gratuita.** Isto é ouro. (Cuidado RGPD: são dados de menores — a marca não deve repostar relatórios reais de crianças sem consentimento explícito; usar mockups.)
...
- **Oportunidade:** sugerir uma assinatura discreta opcional no template ("via FutsalCoach") transforma cada convocatória num anúncio. (Não está no código — é recomendação de produto.)
...
| 7 | **Carrossel educativo** | "5 estatísticas que devias registar nos teus sub-12 (e porquê)" — valor puro sobre metodologia de futsal, marca subtil. Posiciona o FutsalCoach como autoridade. | **Quarta 18h** |
...
**Estratégia de mix:** 3–5 de alcance amplo (`#futsal`, `#desportoportugues`) + 8–10 de nicho PT (menor volume, **muito maior taxa de conversão** — treinadores e pais portugueses) + `#FutsalCoach` sempre. Rotar por associações distritais em campanhas locais (ex.: `#AFLisboa` `#AFPorto`) quando fizer sentido geográfico.

---

## Avaliação de Potencial Social

**"O FutsalCoach tem potencial orgânico nas redes sociais? MÉDIO-ALTO — porquê?"**

**Argumentos a favor (o que puxa para ALTO):**
- **Loop de UGC embutido e já implementado:** o relatório público (`/r/[token]`) e as convocatórias de WhatsApp carregam marca FutsalCoach em cada partilha. Todas as semanas, dezenas de grupos de pais veem uma convocatória limpa; no fim de época, pais repostam relatórios com o nome do filho. **Este é o motor orgânico mais forte que uma app deste nicho pode ter** — a distribuição acontece nos canais onde os treinadores e pais já vivem (WhatsApp dos escalões).
...
- **RGPD limita a marca:** dados de menores impedem a FutsalCoach de repostar relatórios reais de crianças. O UGC mais poderoso (pai orgulhoso) tem de vir *do* utilizador, não *da* marca — o que é bom para autenticidade mas reduz o controlo editorial.
