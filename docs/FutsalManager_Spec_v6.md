...
- **RPE individual (`RpeAtleta`, 1-10):** cada atleta pode reportar o seu próprio esforço percebido para uma sessão (upsert; um valor por atleta/sessão). Permite carga percebida por jogador (FUTURO: agregação por atleta na vista individual).
...
- **Estado vazio:** sem RPE registado, a secção não é mostrada.
